...
<form style="display: hidden" action="/RFIDAssetTracking/viewTicketDetails" method="POST" id="form">
  <input type="hidden" id="listDetails" name="listDetails" value=""/>
</form>
	<div class="wrapper">
		<!--
					...
					<div class="row">
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body " onclick="location.href='/RFIDAssetTracking/technicianAssignedTickets'" id="executive_assign_div" style="cursor:pointer;">
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body" onclick="location.href='/RFIDAssetTracking/technicianClosedTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;" >
									<div class="row align-items-center">
										<div class="col-icon">
