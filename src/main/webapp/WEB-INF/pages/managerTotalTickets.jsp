		...
		{					
			$.ajax({
                ...
                success:function(data) {
         		   ...
         		   {
                    	dataSet.push([totalTicketsList[i].ticketNum,totalTicketsList[i].executiveName,totalTicketsList[i].customer.customerId,totalTicketsList[i].status]);
					...
					<div class="row">
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body " onclick="location.href='/RFIDAssetTracking/managerTotalTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" id="managerTotalTickets" style="color:#ffffff;"></h4>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body " onclick="location.href='/RFIDAssetTracking/managerRejectedTickets'" style="cursor:pointer;">
									<div class="row align-items-center">
										<div class="col-icon">
											<div class="icon-big text-center icon-primary bubble-shadow-small" style="background:#af91e1;border-radius: 5px">
											<img src="<c:url value='resources/assets/img/open.svg' />" >
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" id="managerRejectedTickets" ></h4>
											</div>
										</div>
									</div>
								</div>
