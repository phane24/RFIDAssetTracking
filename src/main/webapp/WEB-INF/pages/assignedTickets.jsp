		...
		{			
			$.ajax({
                ...
                success:function(data) {
                    closeTicketsList = JSON.parse(data);
					
                    for(var i=0;i<closeTicketsList.length;i++)
         		   {
                    	closedDataSet.push([closeTicketsList[i].ticketNum,closeTicketsList[i].customer.customerId,closeTicketsList[i].status]);
         			   
         		   }
                   
                    
			 var table1=$('#closeTickets').DataTable({
					destroy:true,
					language: {
			...
			$.ajax({
	               ...
	               success:function(result) {
	                 ...
	                 //$('#unassignedTicketCount')[0].innerHTML=jsonArr[2][0];
	                  $('#historyTicketCount')[0].innerHTML=jsonArr[2][0];
	                  $('#totalTicketCount')[0].innerHTML=jsonArr[3][0]; 
		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body" onclick="location.href='/RFIDAssetTracking/closedTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;">
									<div class="row align-items-center">
										<div class="col-icon">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" id="closedTicketCount" style="color:#ffffff;"></h4>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="closeTickets" class="display table table-striped table-hover" >
			...
			<%} } %>
				 ...
				 <% if(role!=null){ if (role.equalsIgnoreCase(("SuperAdmin"))) { %>
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body" onclick="location.href='/RFIDAssetTracking/assignedTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;">
									<div class="row align-items-center">
										<div class="col-icon">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" id="assignedTicketCount" style="color:#ffffff;"></h4>
											</div>
										</div>
									</div>
								</div>
...
<!-- 						<div class="col-sm-6 col-md-3"> -->
<!-- 							<div class="card card-stats card-round"> -->
<!-- 								<div class="card-body" onclick="location.href='/RFIDAssetTracking/unAssignedTickets'" style="cursor:pointer;"> -->
<!-- 									<div class="row align-items-center"> -->
<!-- 										<div class="col-icon"> -->
<!-- 											<div class="icon-big text-center bubble-shadow-small" style="background:#808080;border-radius: 5px;"> -->
<%-- 											<img src="<c:url value='resources/assets/img/history.svg' />" > --%>
