	...
	<script>
		           ...
		           $.ajax({
		                ...
		                success: function(result) {
		                	...
		                	for(i=0;i<executivesList.length;i++){
		            			var newrow = $('<tr><td><a href="#" onclick=saveExecutives(this)>'+executivesList[i].executiveId+'</a></td><td>'+executivesList[i].executiveName+'</td> </tr>');
		...
		function saveExecutives(value){
			...
			$.ajax({
                ...
                swal('Ticket '+ticketId+' assigned to technician '+techId, {
						type : "info",
						buttons: {        			
							confirm: {
