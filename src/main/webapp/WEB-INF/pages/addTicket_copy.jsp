...
<div id="sidebar">
        ...
        <div class="login-form">
                ...
                <form:input id="ticketId" path="ticketNum" name="ticketId" class="form-control input-solid" />
            	<label for="ticketId" class="placeholder">Ticket ID</label>
            	</div>
            		<div class="form-check">
										<label>Ticket Type</label><br>
										<label class="form-radio-label">
											<input class="form-radio-input" type="radio" name="optionsRadios" path="ticketType" value="" checked="">
											<span class="form-radio-sign">New</span>
										</label>
										<label class="form-radio-label ml-3">
											<input class="form-radio-input" type="radio" name="optionsRadios"  path="ticketType" value="">
            	...
            	<label for="uniqueId" class="placeholder">Unique ID</label>
               	...
               	<div class="form-group">
					...
					<textarea class="form-control" id="ticketDescription" path="ticketDescription" rows="5">
            	 	...
            	 	<div class="form-group form-floating-label">
                <form:select id="status" path="status" name="status" class="form-control input-border"  >
                			 <form:option value="Select">Select</form:option>
               		 		 <form:option value="Open">Open</form:option>
              				 <form:option value="InProgress">In Progress</form:option>
              				 <form:option value="Close">Close</form:option>
                </form:select>
                <label for="rack" class="placeholder">Status</label>
            	</div> 
            	<div class="form-group form-floating-label">
                <form:select id="severity" path="severity" name="severity" class="form-control input-border"  >
                			 <form:option value="Select">Select</form:option>
