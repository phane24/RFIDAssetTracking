		...
		{			
			$.ajax({
                ...
                success:function(data) {
         		   ...
         		   {
                    	dataSet.push([openTicketsList[i].ticketNum,openTicketsList[i].customer.customerId,openTicketsList[i].ticketType,openTicketsList[i].region,openTicketsList[i].city]);
         			   
         		   }
                   
                    
			 var table1=$('#openTickets').DataTable({
					destroy:true,
					language: {
					...
					<div class="row">
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body " onclick="location.href='/RFIDAssetTracking/adminOpenTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;">
