		...
		{			
			$.ajax({
                ...
                success:function(data) {
         		   ...
         		   {
                    	dataSet.push([totalTicketsList[i].ticketNum,totalTicketsList[i].customer.customerId,totalTicketsList[i].ticketType,totalTicketsList[i].status]);
			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body" onclick="location.href='/RFIDAssetTracking/totalTickets'" style="background-color:#00B1BF;border-radius: 10px;cursor:pointer;">
									<div class="row align-items-center">
										<div class="col-icon">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" id="totalTicketCount" style="color:#ffffff;"></h4>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="totalTickets" style="width:100%" class="display table table-striped table-hover dataTable"  aria-describedby="basic-datatables_info">
